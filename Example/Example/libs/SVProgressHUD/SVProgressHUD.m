...
static const CGFloat SVProgressHUDRingRadius = 25;
...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
        ...
        SVProgressHUDRingThickness = 2.5f;
...
#pragma clang diagnostic pop
        ...
        CGFloat labelRectY = (imageUsed || progressUsed) ? 70.0f : 9.0f;
...
- (SVIndefiniteAnimatedView *)indefiniteAnimatedView {
    if (_indefiniteAnimatedView == nil) {
        ...
        _indefiniteAnimatedView.strokeColor = [UIColor grayColor];
...
- (UIView *)hudView {
    if(!_hudView) {
        ...
        _hudView.layer.shadowOpacity = 0.5f;
        _hudView.layer.shadowRadius = 5.0f;
        _hudView.layer.shadowOffset = CGSizeMake(0.0f, 0.0f);
